...
def main(df):
    ...
    print (f'Single window of stockdata history for {rand_values}')
    print (x_train_uni[rand_values])
    print (f'\n Target stockdata to predict for {rand_values}')
    print (y_train_uni[rand_values])

    
    plot = show_plot([x_train_uni[rand_values], y_train_uni[rand_values]], 0, f'Sample Example for {rand_values}')
    plot.show()   
