...
if __name__ == '__main__':
    ...
    stock_data_file = 'C:/Project/stock_graph/util/StockDataPreparationUtil/USDRUB+.csv'
    #stock_data = pd.read_csv(stock_data_file)

    #result = model_calc(stock_data)
    result = asyncio.run(model_calc(stock_data_file))
    result.to_csv('C:/Project/stock_graph/util/StockDataPreparationUtil/USDRUB++.csv', index=False)
